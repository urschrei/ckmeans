...
// run with `LD_LIBRARY_PATH=target/release ./ckmeans_example` from project root
...
int main(int argc, const char *argv[]) {
    double input[22] = {1.0, 12.0, 13.0, 14.0, 15.0, 16.0, 2.0, 2.0, 3.0, 5.0, 7.0, 1.0, 2.0, 5.0, 7.0, 1.0, 5.0, 82.0, 1.0, 1.3, 1.1, 78.0};
